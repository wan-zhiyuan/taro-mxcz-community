...
export default function Search() {
    ...
    // 如果需要历史搜索、热门搜索等模块，建议search单独页面，searchResult单独页面，
    // searchResult页面也有搜索框跳转search页面，两个页面的跳转都不放入栈，这样返回都是返回首页
    ...
    const [activityList, setActivityList] = useState([
        {
            ...
            ], publishTime: '2020-08-07 15:55', readed: '5468', praise: '58'
        },
        {
            ...
            ], publishTime: '2020-07-07 01:55', readed: '1255', praise: '200'
        },
        {
            ...
            ], publishTime: '2020-02-011 12:00', readed: '900', praise: '198'
        },
        {
            ...
            ], publishTime: '2020-01-20 09:06', readed: '12306', praise: '2453'
        },
        {
            ...
            ], publishTime: '2019-06-19 21:23', readed: '4763', praise: '2500'
        },
    ])
