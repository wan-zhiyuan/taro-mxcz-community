...
import PublisgList from '../../../components/PublishList'
    ...
    const [publishList, setPublishList] = useState([
        {
            ...
            nickname: '老王', content: '众所周知，酷热炎炎夏季是白酒的销售淡季，在这个时候，是选择默默等待淡季来临?还是未雨绸缪将促销进行到底，打一场漂亮的淡季冲锋战?相信贵厂一定会明智的选择后者! ',
            images: 
            ...
            , create_time: '1600502282', read_number: '5468', likes_number: '58',distance: 5820,
        },
        {
            ...
            nickname: '老万', content: '为迎接中国第四届国际动漫节的召开，欢庆“五一”国际劳动节，提高广大干部群众的环境卫生意识，进一步推进街道实施“最清洁城乡”工程，根据杭州市“第四次百万市民清洁大行动”统一部署，经研究，决定在全街道组织开展以“迎动漫、庆五一”为主题的清洁城乡大行动。',
            images: 
            ...
            , create_time: '1600502282', read_number: '1255', likes_number: '200',distance: 100,
        },
        {
            ...
            , create_time: '1600502282', read_number: '900', likes_number: '198',distance: 19820,
        },
        {
            ...
            nickname: '小确幸', content: '为了深入开展“爱我环保模范城”环保主题月活动，进一步提高我校学生的环保意识和激发学生参与环保社会实践活动的积极性，积极响应市教育局、市环保局的号召，通过小手牵大手、孩子带动家庭的形式，发动全社会关注污染减排，以实际行动保护身边的环境。经学校研究决定：我校将举行“校园二手市场进社区”活动。',
            images: 
        ...
        },
        {
            ...
            , create_time: '1600502282', read_number: '4763', likes_number: '2500',distance: 7820,
        },
    ])
